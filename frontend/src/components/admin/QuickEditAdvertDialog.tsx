  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateAdvert(advertUuid, {
        ...
        apartmentFloor: advert.apartmentFloor ?? undefined,
        apartmentNumber: advert.apartmentNumber ?? undefined,
        apartmentBlock: advert.apartmentBlock ?? undefined,
        gardenSquareMeters: advert.gardenSquareMeters ?? undefined,
